...
#ifndef STASSID
#define STASSID "ENTER_SSID"
#define STAPSK  "ENTER_PASS"
#endif


#define CLOCK 2 //  AY0438 clock
#define DATA 4   //  AY0438 data
#define LOAD 5  //  AY0438 load
...
const char* ntpServerName = "3.ua.pool.ntp.org";
...
void loop() {
  ...
  if (!showColon)
    sprintf(buf, "%02d%02d\0", (((epoch  % 86400L) / 3600) + 3), ((epoch  % 3600) / 60)); //hours, mins
  else
    sprintf(buf, "%02d.%02d\0", (((epoch  % 86400L) / 3600) + 3), ((epoch  % 3600) / 60)); //hours, mins
